      ...
      <div className="flex flex-col lg:flex-row items-center gap-8 xl:gap-12 max-w-7xl mx-auto">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <div className="flex gap-4">
            ...
            {/* Link */}
            <a className="relative inline-flex items-center justify-start w-full sm:w-[181px] h-[64px] py-3 pl-4 pr-12 overflow-hidden font-semibold text-[#2b2b2b] transition-all duration-150 ease-in-out rounded hover:pl-10 hover:pr-6 group">
